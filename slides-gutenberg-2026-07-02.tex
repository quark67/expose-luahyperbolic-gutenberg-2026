...
%
%Voir pdfs d'introduction à la géométrie hyperbolique.
%
%\newpage
%
...
\titre{Attention !!\\ Le 5\ieme{} postulat d'Euclide\\tombe en défaut!}
...
\item Livre : \emph{Programming in Lua} (5\ieme{} édition, 1\iere{} édition gratuite sur \url{https://www.lua.org/pil/contents.html}
...
\titre{Partie III\\ Quelques fonctionnalités\\du package \og luahyperbolic \fg}
...
\paragraph{Module \og complex \fg} (petite lib de nombres complexes)
\ttfamily
\begin{multicols}{5}
